package cab.bean.srvcs.tube4kids.cli;

import cab.bean.srvcs.tube4kids.Tube4kidsConfiguration;
...
public class RenderCommand extends ConfiguredCommand<Tube4kidsConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<Tube4kidsConfiguration> bootstrap,
                       Namespace namespace,
                       Tube4kidsConfiguration configuration) throws Exception {
