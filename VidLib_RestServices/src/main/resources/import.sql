...
CREATE TABLE IF NOT EXISTS `user` (   `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,   `email` VARCHAR(254) NOT NULL,   `email_verified` TINYINT(4) NOT NULL DEFAULT '0',   `password` VARCHAR(255) NULL DEFAULT NULL,   `activated` TINYINT(4) NULL DEFAULT '0',   `firstname` VARCHAR(127) NULL DEFAULT NULL,   `lastname` VARCHAR(127) NULL DEFAULT NULL,   `updated_at` TIMESTAMP NULL DEFAULT NULL,   `last_login` TIMESTAMP NULL DEFAULT NULL,   `reset_password_code` VARCHAR(255) NULL DEFAULT NULL,   `activated_at` TIMESTAMP NULL DEFAULT NULL,   `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,   `activation_code` VARCHAR(255) NULL DEFAULT NULL,   PRIMARY KEY (`id`)) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8;
